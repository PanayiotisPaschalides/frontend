...
class Messenger extends Component {
    ...
    LoadChatItems(){
        ...
        axios.get(config.Get_Load_Chat_Items, {
            params:{
    ...
    LoadMessages(id){
        axios.get(config.Get_Load_Messages, {
            params:{
                ChatID : id
            }
        })
    ...
    SendMsg(){
        ...
        if(this.state.ActiveChat !== undefined && this.state.MessengerMsg !== '')
        {
            ...
            axios.post(config.Post_Send_Msg,MessageBody)
            .then((response)=>{
    ...
    CheckRead(id){
        axios.get(config.Get_Check_Read, {
            params:{
                UserName : this.state.logUser,
                ID: id
            }
    ...
    UpdateStatus(User,Status){
        ...
        axios.post(config.Post_Update_Status,Data)
        .then((response)=>{
            if(response.data.status){
    ...
    ReadMsg(){
        ...
        axios.post(config.Post_Read_Message,Data)
        .then((response)=>{
            if(response.data.status){
    ...
    UpdateChat(msg){
        ...
        axios.post(config.Post_Update_Chat,Data)
        .then((response)=>{
            if(response.data.status){
                this.LoadChatItems();
            }
